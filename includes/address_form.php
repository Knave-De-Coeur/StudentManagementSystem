...
<fieldset>
    ...
    <?php
        if(!$addingStudent && $addingAddress){
    ...
    <div class="label-input-wrapper">
        ...
        <?php if(!$addingAddress) echo "value='{$addressModel->getAddress1()}'"; ?>">
    </div>
    <div class="label-input-wrapper">
    ...
    <div class="label-input-wrapper">
        ...
        <?php if(!$addingAddress) echo "value='{$addressModel->getState()}'"; ?>">
    </div>
    <div class="label-input-wrapper">
        <label for="post-code">Post/Zip Code: </label>
        <input type="text" name="post-code" placeholder="Enter Post/Zip Code"
        <?php if(!$addingAddress) echo "value='{$addressModel->getZipPostalCode()}'"; ?>">
    </div>
</fieldset>
